...
Assignment: W08 Teach - Family History
"""
...
def print_marriages(marriages_dict, people_dict):
    ...
    for _ in marriages_dict.values():
        husband = people_dict[_[0]]
        wife = people_dict[_[1]]
        year = _[2]
        h_age = year - husband[2]
        w_age = year - wife[2]
        print(f'{husband[0]} {h_age} > {year} < {wife[0]} {w_age}')
    pass
